...
import { NodeParams,
  ...
  DBListenerArray, DBTwoWayArray, DBTwoWay, DBWriteBuffer } from '../model/dbnodes';
...
export class PedalStatus extends EventEmitter {
  ...
  constructor(db: Database) {
    ...
    // this.pick_data = new DBWriteBuffer({...params('pick-data')});
    // this.pick_data.attach();
    // this.pick_data.setVal(false);
